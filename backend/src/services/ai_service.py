...
class CodeGenerator:
    ...
    def generate_code(self, scene_type: str, prompt: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _get_remotion_template(self, prompt: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
...
export const Scene: React.FC = () => {{
  ...
  return (
    ...
    def _get_manim_template(self, prompt: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
...
'''
    ...
    def _get_text_template(self, prompt: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
...
class AIService:
    ...
    async def process_prompt(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            code_spec = self.code_generator.generate_code(scene_type, prompt, parameters)
