...
from ..database.repository import VideoRepository, JobRepository, ProjectRepository, AssetRepository
from ..database.schemas import JobCreate
from ..workers.tasks.video_processing import generate_video, render_video_blender, process_video_upload
import uuid
import logging
...
class TaskManager:
    ...
    def queue_video_generation(self, video_id: int, user_id: int, engine: str = "default") -> str:
    ...
    def queue_video_upload_processing(self, asset_id: int, video_id: int, user_id: int) -> str:
