...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, video_id: str):
        ...
        logger.info(f"WebSocket connected for video {video_id}. Active connections: {len(self.active_connections[video_id])}")
    ...
    def disconnect(self, websocket: WebSocket):
        ...
        if video_id and video_id in self.active_connections:
            ...
            logger.info(f"WebSocket disconnected for video {video_id}. Active connections: {len(self.active_connections.get(video_id, set()))}")
    ...
    async def broadcast_progress_update(self, video_id: str, progress: int, stage: str = "", status: str = "", error: str = None):
    ...
    async def broadcast_completion(self, video_id: str, output_url: str = "", thumbnail_url: str = ""):
