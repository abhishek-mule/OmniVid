...
class TestAuthenticationFlows:
    ...
    def test_oauth_flow_simulation(self):
        ...
        for provider in providers:
            ...
            redirect_url = f"https://omnivid.com/auth/callback?provider={provider}&code=mock_code"
...
class TestBackwardCompatibility:
    ...
    def test_legacy_jwt_fallback(self):
        ...
        with patch('supabase.create_client', side_effect=Exception("Supabase unavailable")):
...
def run_authentication_tests():
    ...
    for test_class in test_classes:
        ...
        methods = [method for method in dir(class_instance) if method.startswith('test_')]
