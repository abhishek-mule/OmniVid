...
from ..src.workers.tasks.video_processing import generate_video, render_video_blender, process_video_upload
...
def test_queue_video_generation(mock_project_repo, mock_job_repo, mock_video_repo, mock_session_local, task_manager):
