...
from ..src.database.repository import UserRepository, ProjectRepository, VideoRepository, AssetRepository, JobRepository
from ..src.database.schemas import UserCreate, ProjectCreate, VideoCreate, AssetCreate, JobCreate
...
# Job tests
def test_create_job(job_repository, user_repository, project_repository, video_repository):
    # Create user, project, and video
    user_data = UserCreate(
        email="test@example.com",
        username="testuser",
...
def test_get_job_by_task_id(job_repository, user_repository, project_repository, video_repository):
