      ...
      <div className="w-full max-w-md">
        <div className="bg-slate-800/50 backdrop-blur-md rounded-2xl p-8 border border-slate-700/50 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Sign in to your OmniVid account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium rounded-lg transition-all duration-300"
              disabled={isLoading}
            >
          ...
          <div className="mt-8 pt-6 border-t border-slate-700">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button variant="outline" className="h-10 bg-slate-800 border-slate-700 text-slate-300 hover:bg-slate-700">
