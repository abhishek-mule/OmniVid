...
function AuthProvider(_a) {
    ...
    var refresh = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    json = _a.sent();
                    setAuthenticated(!!(json === null || json === void 0 ? void 0 : json.authenticated));
                    return [3 /*break*/, 6];
                case 4:
                    e_1 = _a.sent();
                    setError(e_1 instanceof Error ? e_1.message : 'Session check failed');
                    return [3 /*break*/, 6];
                case 5:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    var value = { authenticated: authenticated, loading: loading, error: error, refresh: refresh, logout: logout };
