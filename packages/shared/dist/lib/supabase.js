...
var createClient = function () {
    ...
    if (typeof window === 'undefined') {
        var noop = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, ({ data: null, error: new Error('Supabase not available on server') })];
        }); }); };
        return {
            auth: {
    ...
    var isValidUrl = !!url && /^(https?:)\/\//.test(url);
    if (!isValidUrl || !key) {
        if (process.env.NODE_ENV !== 'production') {
            console.warn('Supabase env missing or invalid; returning no-op client');
        }
        var noop = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, ({ data: null, error: new Error('Supabase not configured') })];
        }); }); };
        return {
            auth: {
                onAuthStateChange: function () { return ({ data: { subscription: { unsubscribe: function () { } } } }); },
